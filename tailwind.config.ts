	...
	theme: {
		...
		extend: {
			colors: {
				...
				zodiac: {
					'deep-blue': '#0A1128',
					'midnight-blue': '#1C1C40',
					'twilight-purple': '#3E2F5B',
					'mystic-purple': '#673AB7',
					'cosmic-indigo': '#4054B2',
					'celestial-blue': '#2196F3',
			...
			backgroundImage: {
				...
				'gradient-cosmic': 'linear-gradient(to bottom right, #0A1128, #3E2F5B, #1C1C40)',
			},
		}
	},
